...
// TODO если ответ - длинный, то вопрос долго не показывается (хотя и распознан)
// TODO логировать запросы (на сервере)
// TODO clearAnswers в llm.js не используется + вообще не понятно, сохраняется ли контекст между запросами (надо использовать messages вместо n)
// TODO перевести все в ogg и избавиться от ffmpeg
// TODO обработка ситуации когда запрещен доступ к микрофону
